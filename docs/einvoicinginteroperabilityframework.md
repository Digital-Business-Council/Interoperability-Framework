...
- When transforming an invoice between various formats the mappint of information is easier for software developers if there is a common semantic model to reference.
